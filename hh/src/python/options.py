...
class TissueTypeOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--patch_size', type=int, default=5, help="size of patches to extract")
        self.parser.add_argument('--segmenter_weights', default=os.path.abspath(os.getcwd()+'/python/patch_weights/processed_weights.pth'), help="path to ulcer segmentation model weights")
        self.parser.add_argument('--classifier_weights', default=os.path.abspath(os.getcwd()+'/python/patch_weights/multi_processed_weights.pth'), help="path to tissue type classifier weights")
